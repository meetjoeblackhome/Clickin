...
function custom_scripts() {
	...
	wp_enqueue_script( 'custom-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'custom-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
...
function theme_add_bootstrap() {
	...
	wp_enqueue_style( 'bootstrap-theme-css', get_template_directory_uri() . '/bower_components/bootstrap/dist/css/bootstrap-theme.min.css' );
	wp_enqueue_script( 'jquery-js', get_template_directory_uri() . '/bower_components/jquery/dist/jquery.min.js', array(), '4.3.0', true );
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/bower_components/bootstrap/dist/js/bootstrap.min.js', array(), '3.0.0', true );
}
